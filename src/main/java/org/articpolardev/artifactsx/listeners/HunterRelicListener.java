...
public class HunterRelicListener implements Listener {
    ...
    public static ItemStack createHunterRelic() {
        ...
        if (meta != null) {
            ...
            String FName = NameFormat.RelicNameFormat("#ff0033", "Relíquia do CAÇADOR");
